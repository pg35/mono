...
function Row({ role, config, onChange }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "text-left px-4 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        type: "checkbox",
        name: "enable",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2 text-gray-700", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "select",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "Do not change" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "discount", children: "Discrease" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "surcharge", children: "Increase" })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2 text-gray-700", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
...
function App() {
  ...
  function handleChange(role, name, value) {
    ...
    if (newConfig.length) {
      ...
      newConfig = Object.keys(newState[1]).filter((x2) => x2 === role).map((x2) => newState[1][x2]);
      newState[1][role] = { ...newConfig[0], [name]: value };
    }
